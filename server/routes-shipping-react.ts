...
export function registerReactShippingRoutes(app: Express): void {
  ...
  console.log("✅ Rutas del formulario React registradas: /api/shipping/check-customer-v2, /api/shipping/check-duplicate, /api/shipping/draft, /api/shipping/final, /api/shipping/list");
}
