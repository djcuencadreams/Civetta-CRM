...
export const shippingFormSchema = z.object({
  ...
  firstName: z.string().optional(), // Nuevo campo para soporte de nombre estandarizado
  lastName: z.string().optional(),  // Nuevo campo para soporte de apellido estandarizado
          ...
          try {
            ...
            await db.update(customers)
              .set({
                ...
                // Actualizamos también los campos firstName y lastName si se proporcionan
                firstName: formData.firstName || customer.firstName,
                lastName: formData.lastName || customer.lastName,
